...
namespace Shoopi.Controllers
{
    public class FavoritesController : Controller
    {
        ...
        public FavoritesController(ShoopiContext context)
        {
            _context = context;
        }
        ...
        {
            var shoopiContext = _context.Favorites.Include(f => f.Product).Include(f => f.User);
        ...
        public async Task<IActionResult> Create([Bind("FavoriteId,Day,Detail,UserId,ProductId")] Favorite favorite)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FavoriteId,Day,Detail,UserId,ProductId")] Favorite favorite)
        {
